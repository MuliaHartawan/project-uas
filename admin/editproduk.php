                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="idkategori" class="form-control">
                                            <option <?php if ($kategori['idproduk'] === $idkategori) echo "selected"; ?>><?php $kategori['namakategori'] ?></option>
                                            <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="rate" type="number" class="form-control" min="1" max="5" value="<?= $rating ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Harga Sebelum Diskon</label>
                                        <input name="hargabefore" type="number" class="form-control" value="<?= $hargasebelum ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Harga Setelah Diskon</label>
                                        <input name="hargaafter" type="number" class="form-control" value="<?= $hargasetelah ?>">
                                    </div>
                                    <div class=" form-group">
                                        <label>Gambar</label>
                                        <input name="uploadgambar" required type="file" class="form-control">
                                    </div>

                            </div>
                            <div class="modal-footer">
                                <a href="produk.php" class="btn btn-default btn-outline-dark" data-dismiss="modal">Batal</a>
                                <input name="updateproduct" type="submit" class="btn btn-warning" value="Edit">
                            </div>
                            </form>
                        </div>
                    </div>
