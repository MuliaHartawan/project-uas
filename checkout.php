...
<head>
    <title>Selikur Thrift - Checkout</title>
    <!-- for-mobile-apps -->
...
<body>
    ...
    <div class="checkout">
        <div class="container">
            <h1>Terima kasih, <?= $_SESSION['name'] ?> telah membeli <?php echo $itungtrans3 ?> barang di Selikur Thrift</span></h1>
    ...
    <div class="footer-botm">
        <div class="container">
            ...
            <div class="payment-w3ls">
                <img src="public/img/card.png" alt=" " class="img-responsive">
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
