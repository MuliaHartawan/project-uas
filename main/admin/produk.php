...
<body>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-sm-flex justify-content-between align-items-center">
									<h2>Daftar Produk</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#insertModal" class="btn btn-info col-md-2">Tambah Produk</button>
								</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="editproduk.php?id= <?= $p['idproduk'] ?>" class="btn btn-warning my-2 mx-1">Edit</a> <a href="hapusproduk.php?id=<?= $p['idproduk'] ?>" onclick=" return confirm('apakah kamu yakin mengapus produk?')" class="btn btn-danger mx-1 my-2">Hapus</a>
													<td>
	...
	<div id="updateModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="produk.php" method="post" enctype="multipart/form-data">
						<input name="idproduk" id="id_produk" hidden type="text" class="form-control">
						<div class=" form-group">
							<label>Nama Produk</label>
							<input name="namaproduk" id="nama_produk" type="text" class="form-control required autofocus>
								</div>
								<div class=" form-group">
							<label>Nama Kategori</label>
						...
						<div class="form-group">
							<label>Deskripsi</label>
							<input name="deskripsi" id="deskripsi" type="text" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Rating (1-5)</label>
							<input name="rate" type="number" id="rating" class="form-control" min="1" max="5" required>
						</div>
						<div class="form-group">
							<label>Harga Sebelum Diskon</label>
							<input name="hargabefore" type="number" id="harga_before" class="form-control">
						</div>
						<div class="form-group">
							<label>Harga Setelah Diskon</label>
							<input name="hargaafter" type="number" id="harga_after" class="form-control">
						</div>
						<div class="form-group">
							<label>Gambar</label>
							<input name="uploadgambar" type="file" class="form-control">
	...
	<script>
		...
		$(document).on("click", "#tombolUpdate", function() {
			...
			let hargaAfter = $(this).data('after');
			let hargaBefore = $(this).data('before');
			let deskripsi = $(this).data('deskripsi');
			let rate = $(this).data('rate');

			console.log(id, namaProduk, kategori);
			$("#id_produk").val(id);
			$("#.namaproduk nama_produk").val(namaProduk);
			$("#kategori").val(kategori);
			$("#deskripsi").val(deskripsi);
			$("#rating").val(rate);
			$("#harga_before").val(hargaBefore);
			$("#harga_after").val(hargaAfter);
		});
	</script>
